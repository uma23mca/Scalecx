...
if ( ! class_exists( 'WPGMP_Model_Map' ) ) {
	...
	class WPGMP_Model_Map extends FlipperCode_Model_Base {
		...
		function save() {
			...
			if(isset($_POST['map_all_control']['infowindow_setting'])){
				$_POST['map_all_control']['infowindow_setting'] = balanceTags( wp_kses_post( $_POST['map_all_control']['infowindow_setting'] ), true );
			}
